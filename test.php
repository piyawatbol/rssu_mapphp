...
<head>
    <?php   
require('../server.php');
$sql = "SELECT  * FROM tb_place WHERE place_name = 'ตำหนักเอื้อนอาชว์แถมถวัลย์' GROUP by place_gps";	
//เดิน 1ชม. ประตูหน้า 
...
<body>
    ...
    L.marker([<?php echo $lat ?>], {
        ...
        .bindPopup(
            '<b><?php echo $name ?></b> <br> <a href="https://maps.google.com/maps?q=<?php echo $lat ?>"> นำทางนะจ๊ะ</a>'
            )
        .openPopup();
