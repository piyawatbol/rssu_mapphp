...
<head>
    <?php
    require('../server.php');
    $sql = "SELECT * FROM `tb_place` WHERE `place_status` = 60 AND`place_door` = 2 ORDER BY `place_id` DESC ";
    //เดิน 1ชม. ประตูหลัง 
    $db_query = mysqli_query($conn, $sql);
    ?>

    <title>ประตูหลัง 1 ชั่วโมง</title>
...
<body>
    ...
    <script>
        ...
        var polygon = L.polygon([
            [13.77819102633828, 100.50878764946191],
            [13.777641201979096, 100.50994357451222],
            [13.777152752277548, 100.50968816510517],
            [13.776797283004663, 100.50863756352362],
            [13.777014656365274, 100.50815307557623],
