...
<?php   
require('../server.php');
$sql = "SELECT * FROM `tb_place` WHERE `place_status` = 150 AND`place_door` = 2 ORDER BY `place_id` DESC  ";	
//เดิน 2ชม ประตูหลัง  
$db_query = mysqli_query($conn,$sql);
?>

    <title>ประตูหลัง 2 ชั่วโมง</title>
...
<body>
    ...
    <script>
       ...
       .bindPopup('<h2>จุดที่ <?php echo $number ?></h2> <b><?php echo $name ?></b><br> <a href="https://maps.google.com/maps?q=<?php echo $lat ?>"> นำทาง</a>')            .openPopup();
