                ...
                <div class="pd-20 card-box mb-30">
                    <div class="wizard-content">
                                ...
                                <div class="pro14">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-10">
                                            <input class="form-control" type="text" name="fullname" placeholder="กรอกข้อมูล">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10 col-md-10">
                                            <input class="form-control" type="text" name="email" placeholder="กรอกข้อมูล">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-10">
                                            <input type="text" id="gender_id" name="tel" required="required" placeholder="กรอกข้อมูล" class="form-control">
                                        </div>
                                    </div>
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $sql1 = " insert into tb_user(user_fullname,user_email,user_tel)";
                            $sql1 .= " values ('$fullname','$email','$tel')";
