                    ...
                    <div class="wizard-content">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <section>
                                <?php
                                $id = $_GET['id'];
                                $sql = "SELECT * from tb_walk where walk_id = '$id' ";
                                ...
                                <div class="pro14">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12 col-md-10">
                                            <input class="form-control" type="text" name="name" value="<?= $name ?>" placeholder="กรอกข้อมูล">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group row">
                        ...
                        if (isset($_POST['submit'])) {
                            $name = $_POST['name'];
                            $id = $_POST['id'];
                            $sql1 = "UPDATE tb_walk set walk_name = '$name' where walk_id = '$id' ";

                            if ($cls_conn->write_base($sql1) == true) {
                                echo $cls_conn->show_message('Success');
                                echo $cls_conn->goto_page(1, 'show_walk.php');
                                // echo $sql1;
                            } else {
